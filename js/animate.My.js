...
//    step 步长
// 目标位置
function Tabs(obj,time){
    var box  = document.getElementById(obj);  //   获得大盒子
    ...
    timer = setInterval(autoplay,time);   // 每隔3s 调用一次 autoplay
    function autoplay() {
        key++;   // key == 1  先 ++
    ...
    box.onmouseout = function() {
        timer = setInterval(autoplay,time);  // 一定这么开
    }
